...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
  ...
  pub fn maybe_balance(
    ...
    Account::<T, I>::get(who.borrow(), id).map(|a| a.balance)
  }
  ...
  pub(super) fn do_refund(id: T::AssetId, who: T::AccountId, allow_burn: bool) -> DispatchResult {
    let mut account = Account::<T, I>::get(&who, id).ok_or(Error::<T, I>::NoDeposit)?;
    let deposit = account
      .reason
      .take_deposit()
  ...
  pub(super) fn increase_balance(
    ...
    Asset::<T, I>::try_mutate(id, |maybe_details| -> DispatchResult {
      ...
      Account::<T, I>::try_mutate(beneficiary, id, |maybe_account| -> DispatchResult {
        match maybe_account {
  ...
  pub(super) fn do_finish_destroy(_id: T::AssetId) -> DispatchResult {
    Ok(())
  }
  ...
  pub(super) fn do_approve_transfer(
    ...
    ensure!(d.status != AssetStatus::Frozen, Error::<T, I>::AssetFrozen);
