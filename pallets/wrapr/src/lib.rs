...
pub mod pallet {
  ...
  impl<T: Config> Default for GenesisConfig<T> {
    fn default() -> Self {
      Self {
        quorum_enabled: true,
        highest_token: 0u128.saturating_mul(1000_000_000_000u128).saturated_into(),
      }
    }
  }
  ...
  impl<T: Config> Pallet<T> {
    ...
    #[pallet::weight(10000)]
    pub fn burn_request(origin: OriginFor<T>) -> DispatchResultWithPostInfo {
    ...
    pub fn confirm_request(
      ...
      Requests::<T>::mutate(request_id, |request| match request {
        ...
        // request not found
        None => Err(Error::<T>::InvalidRequest)?,
      })
    }
  }
