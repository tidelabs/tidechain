...
/// Money matters.
pub mod currency {
  use tidefi_primitives::Balance;

  pub const TIDE: Balance = 100_000_000_000;
  pub const UNITS: Balance = TIDE;
  pub const DOLLARS: Balance = TIDE; // 100_000_000_000
...
pub mod time {
  use tidefi_primitives::{BlockNumber, Moment};
