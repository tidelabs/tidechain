...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("tidefi-substrate-node"),
	impl_name: create_runtime_str!("tidefi-substrate-node"),
	authoring_version: 1,
	spec_version: 100,
	impl_version: 1,
...
pub const MILLISECS_PER_BLOCK: u64 = 2000; // 6000; // 1000
...
parameter_types! {
	...
	pub const MaxSignatories: u16 = 51;
}
