...
impl<T: frame_system::Config> frame_election_provider_support::WeightInfo for WeightInfo<T> {
	fn phragmen(v: u32, _t: u32, d: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((29_806_000 as Weight).saturating_mul(v as Weight))
			// Standard Error: 11_610_000
			.saturating_add((4_905_433_000 as Weight).saturating_mul(d as Weight))
	}
	fn phragmms(v: u32, _t: u32, d: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 89_000
			.saturating_add((25_515_000 as Weight).saturating_mul(v as Weight))
			// Standard Error: 12_474_000
			.saturating_add((4_338_533_000 as Weight).saturating_mul(d as Weight))
	}
}
