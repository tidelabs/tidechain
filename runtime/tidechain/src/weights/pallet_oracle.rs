...
impl<T: frame_system::Config> pallet_oracle::WeightInfo for WeightInfo<T> {
	...
	fn set_status() -> Weight {
		...
		Weight::from_parts(28_631_000, 1026)
	...
	fn set_account_id() -> Weight {
		...
		//  Measured:  `226`
		//  Estimated: `1026`
		// Minimum execution time: 27_446 nanoseconds.
		Weight::from_parts(29_510_000, 1026)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: Oracle OracleAccountId (r:1 w:0)
	...
	fn add_market_maker() -> Weight {
		...
		Weight::from_parts(31_705_000, 1026)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: Oracle OracleAccountId (r:1 w:0)
	...
	fn update_assets_value() -> Weight {
		...
		Weight::from_parts(19_254_000, 1026)
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn remove_market_maker() -> Weight {
		...
		Weight::from_parts(30_451_000, 1026)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn confirm_swap() -> Weight {
		...
		//  Measured:  `3054`
		//  Estimated: `834487`
		// Minimum execution time: 318_293 nanoseconds.
		Weight::from_parts(351_255_000, 834487)
