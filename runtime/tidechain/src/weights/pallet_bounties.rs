...
// --output=./runtime/src/weights/pallet_bounties.rs
...
impl<T: frame_system::Config> pallet_bounties::WeightInfo for WeightInfo<T> {
	...
	fn spend_funds(b: u32, ) -> Weight {
		(5_686_562_000 as Weight)
			// Standard Error: 4_606_000
			.saturating_add((113_487_000 as Weight).saturating_mul(b as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
